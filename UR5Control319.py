...
while vrep.simxGetConnectionId(clientID) != -1:
    ...
    start1 = [-1.57, 0.06, -1.14, 1.06, 1.57, 0.00]
    # start1 = input()
    if start1 == -1:
        break
    for i in range(jointNum):
        # vrep.simxSetJointTargetPosition(clientID, jointHandle[i], 120/RAD2DEG, vrep.simx_opmode_oneshot)    #original
        vrep.simxSetJointTargetPosition(clientID, jointHandle[i], start1[i], vrep.simx_opmode_oneshot)
...
# Step5 CoreControl from the code position #***
