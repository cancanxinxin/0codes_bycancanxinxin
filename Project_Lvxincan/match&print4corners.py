# openCV official version to find a known object in a scene
#coding=utf-8
# 实际测试可用，输出4个角点的位置，但是精确度方面需要想办法进一步提高，2019.1.2
...
parser.add_argument('--input2', help='Path to input image 2.', default='frame24.jpg')
...
# print("A:",int(scene_corners[0,0,0]+img_object.shape[1]),int(scene_corners[0,0,1]))
# print("B:",int(scene_corners[1,0,0]+img_object.shape[1]),int(scene_corners[1,0,1]))
# print("C:",int(scene_corners[2,0,0]+img_object.shape[1]),int(scene_corners[2,0,1]))
# print("D:",int(scene_corners[3,0,0]+img_object.shape[1]),int(scene_corners[3,0,1]))
